...
-- Seed some basic billboard data
INSERT INTO billboards_enhanced (location, size, type, status) VALUES
('Dhanmondi 27, Dhaka', '20x10 ft', 'LED', 'Available'),
('Gulshan 2, Dhaka', '15x8 ft', 'Vinyl', 'Available'),
('Uttara Sector 7, Dhaka', '25x12 ft', 'LED', 'Available');

-- Seed some basic client data  
